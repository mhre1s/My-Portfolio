      ...
      <div className='min-h-screen bg-customPurple flex flex-col items-center'>
        ...
        <section className='mt-14 bg-[#181629] w-full flex justify-center'>
          <div className='max-w-[1280px] w-full px-8 flex justify-center flex-col'>
            ...
            <div>
              <div ref={sectionRef} className={`custom-scroll flex flex-col gap-4 items-center max-w-[400px] max-h-[600px] overflow-y-auto rounded-xl hover:bg-slate-100 duration-200 ${isVisible?'animate-slideIn':''}`}>
                ...
                <p className='text-center text-[#181629]  text-xl'>Objetivo</p>
                <p className='text-[#181629] text-center mx-5'>Este é um projeto feito para um amigo, frontend realizado todo somente por mim.
                ...
                <p className='text-center text-[#181629] text-xl'>
                  Funcionalidades
                </p>
                <p className='text-[#181629] text-center mx-5'>
